In order to launch this h360tk_central_dashboard on local:

```
git clone https://github.com/simpledotorg/h360tk_central_dashboard.git
cd h360tk_central_dashboard
docker compose up -d
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/simpledotorg/h360tk_central_dashboard/main/deployer.sh | bash
```
